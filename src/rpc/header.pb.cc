...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_header_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::sylar_rpc::Header, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::sylar_rpc::Header, service_name_),
  PROTOBUF_FIELD_OFFSET(::sylar_rpc::Header, method_name_),
  PROTOBUF_FIELD_OFFSET(::sylar_rpc::Header, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::sylar_rpc::Header)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::sylar_rpc::_Header_default_instance_),
};

const char descriptor_table_protodef_header_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014header.proto\022\tsylar_rpc\"F\n\006Header\022\024\n\014s"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_header_2eproto = {
  false, false, 105, descriptor_table_protodef_header_2eproto, "header.proto", 
...
Header::Header(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:sylar_rpc.Header)
}
Header::Header(const Header& from)
  ...
  // @@protoc_insertion_point(copy_constructor:sylar_rpc.Header)
}
...
Header::~Header() {
  // @@protoc_insertion_point(destructor:sylar_rpc.Header)
  SharedDtor();
...
void Header::Clear() {
// @@protoc_insertion_point(message_clear_start:sylar_rpc.Header)
...
::PROTOBUF_NAMESPACE_ID::uint8* Header::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:sylar_rpc.Header)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sylar_rpc.Header)
  return target;
}

size_t Header::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sylar_rpc.Header)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:sylar_rpc.Header)
  GOOGLE_DCHECK_NE(&from, this);
  const Header* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Header>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:sylar_rpc.Header)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:sylar_rpc.Header)
    MergeFrom(*source);
  }
}

void Header::MergeFrom(const Header& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:sylar_rpc.Header)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:sylar_rpc.Header)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:sylar_rpc.Header)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::sylar_rpc::Header* Arena::CreateMaybeMessage< ::sylar_rpc::Header >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sylar_rpc::Header >(arena);
}
